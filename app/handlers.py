...
WELCOME_TEXT = (
    ...
    "2) Напиши название — найду первые 10 совпадений. Если в запросе опечатки "
    "(на любом языке), AI поправит их перед поиском.\n"
...
HELP_TEXT = (
    ...
    "Если на сервере включён GROQ_API_KEY, AI перед поиском поправит опечатки на любом "
    "языке (язык запроса не меняется).\n\n"
